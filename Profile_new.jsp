		...
		<div class="row">
			...
			<div class="col-md-2 bg-dark fixed-top" style="height: 100vh;">
				...
				<div class="row nav" >
					...
					<a class="col-md-12 py-4 text-left rounded-0 border-right-0 border-left-0 border-top-0 border-bottom border-dark btn btn-info text-truncate" href="/Fire_Fitness/Payment">CONFIRM BOOKINGS</a>
