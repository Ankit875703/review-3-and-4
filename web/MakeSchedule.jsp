...
<body>
		...
		<div class="row">
			...
			<div class="col-md-2 bg-dark fixed-top" style="height: 100vh;">
				...
				<div class="row nav">
					...
					<% if (member_type.equalsIgnoreCase("Gold") || member_type.equalsIgnoreCase("Platinum")) {%>
			...
			<div class="col-8 offset-2 px-0">
				...
				<form action="MakeSchedule" method="post" name="workoutForm" onsubmit="return validate()">
					<table>
						<tr>
							<td>Select Workout Type :</td>
						...
						<tr>
							<td><input type="submit" name="ishan" value="Check Schedule"></td>
						</tr>
					</table>
				</form>
	...
	function validate() {
		var workout_name = document.forms["workoutForm"]["workout"].value;
		
		if (workout_name == "select") {
