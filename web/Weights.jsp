...
<body>
	...
	<div class="col-12">
	   ...
	   String query = "select t.Name from trainer t, workout w where t.Specialization = w.workout_ID AND w.workout_name = 'Weights'";
		...
		<table>
			...
			<tr>
				...
				<td><select name="time">
					...
					<option>11.00-1.00</option>
					<option>1.30-3.30</option>
