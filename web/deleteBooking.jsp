...
<body>
	...
	<div class="col-12">
	   ...
	   String query2 = "select trainer_ID from trainer where Name = '" +trainer_name+ "'";
	   ...
	   String query3 = "select member_ID from trainer_booking where trainer_ID = '" +trainer_ID+ "' AND Date = '" +d+ "' AND schedule_ID = '" +schedule_ID+ "'";	  
	   ...
	   if (rs3.next())
		...
		<form action="DeleteServlet" method="post" name="radioForm" onsubmit="return radioValidate()">
			<table>
